...
-- -----------------------------------------------------
-- Table `LIKE_IT`.`complains`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `LIKE_IT`.`complains` ;

CREATE TABLE IF NOT EXISTS `LIKE_IT`.`complains` (
  `id` INT NOT NULL,
  `user_id` INT NULL,
  `target_type` ENUM('ANSWER', 'COMMENT', 'POST', 'RATE') NULL,
